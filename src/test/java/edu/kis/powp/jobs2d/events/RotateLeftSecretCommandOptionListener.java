...
public class RotateLeftSecretCommandOptionListener implements ActionListener {
    @Override
    public void actionPerformed(ActionEvent e) {
        ...
        DriverCommandRotate90degrees rotateVisitor = null;
        ...
        commands.clear();
        rotateVisitor = new DriverCommandRotate90degrees(DriverCommandRotate90degrees.Direction.LEFT);
        lastOne.accept(rotateVisitor);
