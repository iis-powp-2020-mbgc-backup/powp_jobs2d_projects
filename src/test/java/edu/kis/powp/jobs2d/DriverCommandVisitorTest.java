...
public class DriverCommandVisitorTest implements ActionListener {

    Job2dDriver driver;

    public DriverCommandVisitorTest(Job2dDriver driver)
    {
        this.driver = driver;
    }
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        if (expectedOperateToCalls == commandCounterVisitor.operateToCounter && expectedSetPostitionCalls == commandCounterVisitor.setPositionCounter
